...
#set.seed(13)
AffinityBiplotAddSpectrogramsSpatial(input.dir.Focal='/Users/denaclink/Desktop/RStudio Projects/gibbonID/DanumDetections/UpdatedDanumDetectionsHQ99/',
                              output.dir.Focal = '/Users/denaclink/Desktop/RStudio Projects/gibbonID/DanumDetections/UpdatedDanumDetectionsHQ99/Thumbnails/',
                              min.freq = 500, max.freq = 1500,main='Female Gibbon Calls',class='fixed',qval=0.2)
#
#
